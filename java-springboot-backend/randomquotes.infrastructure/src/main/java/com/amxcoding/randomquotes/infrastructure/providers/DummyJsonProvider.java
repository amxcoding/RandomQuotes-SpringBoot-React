...
@Component
@Qualifier(Constants.QuoteProviders.DUMMY_JSON)
public class DummyJsonProvider implements IQuoteProvider {

    private static final Logger logger = LoggerFactory.getLogger(ZenQuotesProvider.class);
    private final WebClient webClient;

    public DummyJsonProvider(WebClient.Builder webClientBuilder, @Value("${quoteprovider.dummyjson}") String baseUrl) {
